...
public static class Cryptography
{
    ...
    public static readonly string KeyAes = "iZOTA-EncryptKey";
    ...
    public static string Sign(string dataToSign, string privateFile)
    {
        ...
        {
            Console.WriteLine($"Sign error {e}");
            return string.Empty;
        }
    }
    ...
    public static string HashSHA256(this string value, string secret)
    {
        var sb = new StringBuilder();
        ...
        var result = hmacsha256.ComputeHash(messageBytes);
        foreach (var b in result)
            sb.Append(b.ToString("x2"));
        return sb.ToString();
    }
